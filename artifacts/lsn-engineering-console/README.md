...
A local-first engineering, firmware-development, validation, diagnostic, and firmware-management platform for Laser Safety Network hardware, distributed by Saber Industrial Applications.
...
The current Console release is **v0.3.0 Development Preview** (see `CHANGELOG.md`);
the LSN Protocol, Device Profile, and `LSN-Firmware-Interface-v0.1` package remain
independently versioned at v0.1.

See `docs/QUICK_START.md`, `docs/FIRMWARE_HANDOFF.md`, and `docs/BUILD_AND_RELEASE.md`.